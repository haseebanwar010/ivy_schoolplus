...
class SmExaminationController extends Controller
{
    ...
    public function meritListReportSearch(Request $request)
    {
        ...
        if ($request->method() == 'POST') {
            ...
            return view('backEnd.reports.merit_list_report', compact('exams', 'classes', 'marks_register', 'all_students', 'subjects', 'class', 'section', 'exam', 'exam_id', 'class_id', 'subjectlist', 'allresult_data', 'class_name', 'assign_subjects', 'exam_name','InputClassId','InputExamId','InputSectionId'));
        }
    }
    ...
    public function markSheetReportStudentSearch(Request $request)
    {
        ...
        if ($is_result_available->count() > 0) {
            ...
            return view('backEnd.reports.mark_sheet_report_student', compact('exam_types', 'classes', 'studentDetails', 'exams', 'classes', 'subjects', 'section', 'class_id', 'student_detail', 'is_result_available', 'exam_type_id', 'section_id', 'student_id', 'exam_details', 'class_name'));
        } else {
