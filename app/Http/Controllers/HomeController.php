...
class HomeController extends Controller
{
    ...
    if(Session::has('info_check')){
        ...
        $result_currency=SmGeneralSettings::select('currency')->get();
        $current_currency_symbol=$result_currency[0]['currency'];


        return view('backEnd.dashboard', compact('totalStudents', 'totalTeachers', 'totalParents', 'totalStaffs', 'toDoLists', 'notices', 'toDoListsCompleteds', 'm_total_income', 'm_total_expense', 'y_total_income', 'y_total_expense', 'holidays', 'current_currency_symbol'));
    }
