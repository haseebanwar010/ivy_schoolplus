...
public function up()
{
	...
	$all_translate = [
        ...
        [ NULL, 1 ,'time_zone',' time zone ',' time zone',' time zone ',' time zone'],
        [ NULL, 1 ,'mail','mail','mail','mail','mail'],
        [ NULL, 1 ,'host','host','host','host','host'],
        [ NULL, 1 ,'host','host','host','host','host'],
        [ NULL, 1 ,'encryption','encryption','encryption','encryption','encryption'],
