...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.edit'); ?> <?php echo app('translator')->getFromJson('lang.notice'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->getFromJson('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.communicate'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.edit'); ?> <?php echo app('translator')->getFromJson('lang.notice'); ?></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->getFromJson('lang.edit'); ?> <?php echo app('translator')->getFromJson('lang.notice'); ?> </h3>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            ...
                            <div class="input-effect mt-40">
                                ...
                                <textarea class="primary-input form-control" cols="0" rows="4" name="notice_message" id="notice_message"><?php echo (isset($noticeDataDetails)) ? $noticeDataDetails->notice_message : ''; ?>
                         ...
                         <div class="no-gutters input-right-icon mb-30">
                            <div class="col">
                                <div class="input-effect">
                                    <input class="primary-input date form-control<?php echo e($errors->has('notice_date') ? ' is-invalid' : ''); ?>" id="notice_date" type="text" name="notice_date" value="<?php echo e((isset($noticeDataDetails)) ? date('d/m/y', strtotime($noticeDataDetails->notice_date)) : ' '); ?>">
                                    <label><?php echo app('translator')->getFromJson('lang.notice_date'); ?><span>*</span> </label>
                                    <span class="focus-border"></span>
                        ...
                        <div class="no-gutters input-right-icon">
                            <div class="col">
                                <div class="input-effect">
                                    ...
                                    name="publish_on" value="<?php echo e((isset($noticeDataDetails)) ? date('d/m/y', strtotime($noticeDataDetails->publish_on)) : ' '); ?>">
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12 text-center">
                                <button class="primary-btn fix-gr-bg">
                                    ...
                                    <?php echo app('translator')->getFromJson('lang.update_content'); ?>
                                </button>
                            </div>
                        </div>
                    </div>
