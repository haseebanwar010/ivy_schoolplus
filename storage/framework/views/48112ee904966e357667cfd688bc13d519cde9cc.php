                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="text-center">
                                <h1><?php echo e($current_currency_symbol); ?> <?php echo e(number_format($m_total_income)); ?></h1>
                                <p><?php echo app('translator')->getFromJson('lang.total_income'); ?></p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="text-center">
                                <h1><?php echo e($current_currency_symbol); ?> <?php echo e(number_format($m_total_expense)); ?></h1>
                                <p><?php echo app('translator')->getFromJson('lang.total_expenses'); ?></p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="text-center">
                                <h1><?php echo e($current_currency_symbol); ?> <?php echo e(number_format($m_total_income - $m_total_expense)); ?></h1>
            ...
            <div class="col-lg-12">
                <div class="white-box" id="areaChartDiv">
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="text-center">
                                <h1><?php echo e($current_currency_symbol); ?> <?php echo e(number_format($y_total_income)); ?></h1>
                                <p><?php echo app('translator')->getFromJson('lang.total_income'); ?></p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="text-center">
                                <h1><?php echo e($current_currency_symbol); ?> <?php echo e(number_format($y_total_expense)); ?></h1>
                                <p><?php echo app('translator')->getFromJson('lang.total_expenses'); ?></p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="text-center">
                                <h1><?php echo e($current_currency_symbol); ?> <?php echo e(number_format($y_total_income - $y_total_expense)); ?></h1>
                                <p><?php echo app('translator')->getFromJson('lang.total_profit'); ?></p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
