...
<?php  $setting = App\SmGeneralSettings::find(1);  if(!empty($setting->currency_symbol)){ $currency = $setting->currency_symbol; }else{ $currency = '$'; }   ?> 
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td style="width: 30% "> 
                <img src="<?php echo e(url($setting->logo)); ?>" alt="Anwar" style="width: 100% !important; "> 
                <!--<img src="https://schoolplus.ivylabtech.com/public/uploads/settings/ae9210d7b4eccaf53122a5ba267e7528.png" alt="Haseeb" style="width: 100% !important; ">-->
