    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="<?php echo e(route('online_exam_marks_register', [$online_exam_question->id])); ?>"><?php echo app('translator')->getFromJson('lang.marking'); ?></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row mt-40">
            <div class="col-lg-6 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->getFromJson('lang.marking'); ?></h3>
                </div>
            </div>
        </div>
                ...
                <table class="display school-table school-table-style" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo app('translator')->getFromJson('lang.marking'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                                ...
                                <td>
                                    <?php if(in_array($student->id, $present_students)): ?>
                                        <a class="primary-btn small bg-success text-white border-0" href="<?php echo e(route('online_exam_marking', [$online_exam_question->id, $student->id])); ?>">
                                            <?php echo app('translator')->getFromJson('lang.view_answer_marking'); ?>
                                     </a>
                                    <?php else: ?>
