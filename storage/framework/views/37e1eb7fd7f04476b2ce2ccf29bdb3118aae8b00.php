                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="input-effect">
                                    ...
                                    type="text" name="type" autocomplete="off" value="<?php echo e(isset($leave_type)? $leave_type->type:''); ?>">
                                ...
                                <div class="input-effect mt-25">
                                    ...
                                    type="number" name="total_days" autocomplete="off" value="<?php echo e(isset($leave_type)? $leave_type->total_days:''); ?>" min="0">
