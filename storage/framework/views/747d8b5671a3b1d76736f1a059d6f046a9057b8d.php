    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="<?php echo e(route('parent_subjects', [$student_detail->id])); ?>">Subjects</a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="col-lg-12">
                        ...
                        <table class="display school-table school-table-style" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo e($assignSubject->subject_id != ""? $assignSubject->subject->subject_name:''); ?></td>
                                    <td><?php echo e($assignSubject->teacher_id != ""? $assignSubject->teacher->full_name:''); ?></td>
                                    <td><?php echo e($assignSubject->subject->subject_type == "T"? 'Theory': 'Practical'); ?></td>
                                </tr>
