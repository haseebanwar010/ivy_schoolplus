...
<footer class="footer-area">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-10 text-center setupfooter">
                <!--<p style="color:#fff;"><?php echo $copyright_text; ?> </p>-->
                <p style="color:#fff;">Copyright © 2019 All rights reserved | Powered by <a href="https://www.ivylabtech.com/" target="_blank" style="color:#39b54ae6;"><b>IvyLab Technologies</b></a></p>
            </div>
        </div>
    </div>
</footer>
