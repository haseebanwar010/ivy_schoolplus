                    ...
                    <div class="">
                        ...
                        <div class="parent_details" id="parent_details">
                            ...
                            <div class="row mb-40">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        <input class="primary-input read-only-input" type="text" placeholder="Relation" name="relation" id="relation" value="<?php if(old('relationButton')=="M"){ echo 'Mother';} else if(old('relationButton')=="F"){echo 'Father';} else{echo 'Other';} ?>" readonly>
