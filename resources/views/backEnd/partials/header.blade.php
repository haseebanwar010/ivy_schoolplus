    ...
    if (!empty(Auth::user())) {
        ...
        if ($ROLE_ID == 2) {
            ...
            if (empty($LoginUser)) {
                ...
                if(empty($LoginUser->student_photo))
                {
                    // echo 'in if';
                    // die();
                    // URL::to('/')./public/uploads/student/dynamic_image.png
                    // $profile = $LoginUser->student_photo;
                    $profile ='/public/uploads/student/dynamic_image.png';
                ...
                else
                {
                    ...
                    // echo 'in else';
                    // die();
                    // src="https://schoolplus.ivylabtech.com/public/uploads/student/e19e9afbd6682eda47c1f464fe4ea9e6.png"
                    $profile = $LoginUser->student_photo;
                }
                // echo $LoginUser;
                // echo 'in else';
            ...
            {
                if($LoginUser->relation=='F')
                {
                    $profile = $LoginUser->guardians_photo;
                }
                else if($LoginUser->relation=='M')
                {
                    $profile = $LoginUser->guardians_photo;
                }
                else if($LoginUser->relation=='O')
                {
                    $profile = $LoginUser->guardians_photo;
                }
                else
                ...
                if(empty($LoginUser->guardians_photo))
                {
                    $profile ='/public/uploads/student/dynamic_image.png';
                }
            }
